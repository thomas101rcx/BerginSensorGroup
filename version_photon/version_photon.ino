 ...
 *yyyy/mm/dd hh:mm:ss tsi_pm1 tsi_pm2.5 tsi_pm10 pm1 pm2.5 pm10 CO2 temp(C) humidity(%) NO CO NO2 O3
 *buffer: the name of the file all collected data is logged into
 *calibrationTag: box number formatted as "Box.." used for calibration
 *boxLabel:  box label used in SD log
 */

const char* buffer = "photon.txt";
String boxLabel = "Sensors Box 1";
